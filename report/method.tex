...
To construct a quantum gate, first the use the method of multi-pulse single-loops\cite{sLoop}, the relevant part of the time evolution operator is 
\begin{equation}
\begin{aligned}&
...
\end{figure}
\note{The problem with the H gate}
